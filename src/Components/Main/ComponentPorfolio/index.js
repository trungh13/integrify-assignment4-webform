  ...
  render() {
    return (
      <div className={styles.ComponentPorfolio}>
        ...
        <input type="text" placeholder="Porfolio link*" />
        <textarea name="additionalInformation" id="additionalInformation" cols={30} rows={10} placeholder="Anything else (another link, availability, etc.)?" defaultValue={""} />
      </div>
    )
  }
}
